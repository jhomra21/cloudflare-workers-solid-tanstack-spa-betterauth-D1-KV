...
mock.module('@tanstack/solid-query', () => ({
    useQuery: mock(() => ({
        ...
        error: null, // Property, not function
        refetch: mock(() => Promise.resolve()), // Function
...
describe('TanStack Query Usage Validation', () => {
    ...
    it('should validate that query properties are accessed correctly (not as functions)', async () => {
        ...
        expect(typeof query.data).not.toBe('function');
        expect(typeof query.isLoading).not.toBe('function');
        expect(typeof query.isError).not.toBe('function');
        expect(typeof query.error).not.toBe('function');
        expect(typeof query.isPending).not.toBe('function');

        // These should be functions
        expect(typeof query.refetch).toBe('function');
    });

    it('should validate that mutation properties are accessed correctly', async () => {
        ...
        // These should be properties, not functions
        expect(typeof mutation.isPending).not.toBe('function');
        expect(typeof mutation.error).not.toBe('function');
