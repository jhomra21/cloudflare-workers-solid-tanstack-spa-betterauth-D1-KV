  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium cursor-pointer ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        "sf-compute": "relative z-0 border border-blue-700 bg-gradient-to-b from-blue-400 via-blue-600 to-blue-500 text-white border-b-0 shadow-[inset_0_1px_0_rgba(255,255,255,0.3),inset_0_-1.5px_0_rgba(0,0,0,0.3),0_1px_2px_rgba(0,0,0,0.2)] [text-shadow:0_1px_rgba(0,11,15,0.4)] transition-all duration-200 will-change-transform hover:scale-[1.02] active:scale-[0.98] active:shadow-[inset_0_1px_2px_rgba(0,0,0,0.4)]",
        "sf-compute-destructive": "relative z-0 border border-red-700 bg-gradient-to-b from-red-400 via-red-600 to-red-500 text-white border-b-0 shadow-[inset_0_1px_0_rgba(255,255,255,0.3),inset_0_-1.5px_0_rgba(0,0,0,0.3),0_1px_2px_rgba(0,0,0,0.2)] [text-shadow:0_1px_rgba(0,11,15,0.4)] transition-all duration-200 will-change-transform hover:scale-[1.02] active:scale-[0.98] active:shadow-[inset_0_1px_2px_rgba(0,0,0,0.4)]"
      },
      size: {
